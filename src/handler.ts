...
//     if(!calls[connectionId]) {
//         calls[connectionId] = {connectionId, caller: ws, recipient: null, status: CallStatus.RINGING};
//     }else{
//         calls[connectionId].recipient = ws;
//         calls[connectionId].status = CallStatus.CONNECTING;
//     }
//   let polite = true;
//   if (isPrivate) {
...
export {  onConnect, onDisconnect, onOffer, onAnswer, onCandidate }; // reset, add, remove,
